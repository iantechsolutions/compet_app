...
export function ForecastBudgetEventsRow(props: { events: ProductEvent[], month: string, stock: number }) {
    const openId = useId()
    ...
    return <>
        ...
        <Dialog>
            <DialogTrigger asChild>
                <Button variant="outline" id={openId} className="hidden">Forecast de presupuestos</Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[1200px]">
                <DialogHeader>
                    <DialogTitle>Forecast como presupuesto {props.month}</DialogTitle>
                    <DialogDescription>
                        Predicción de consumo según presupuestos de diferentes productos.
