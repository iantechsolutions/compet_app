...
import { ActivityIcon, ActivitySquareIcon, ArrowLeftIcon, BanknoteIcon, BarChartBigIcon, BarcodeIcon, DatabaseBackupIcon, DollarSignIcon, FileUpIcon, FingerprintIcon, LayoutDashboardIcon, MessageCircleQuestionIcon, MessageSquareReplyIcon, Settings2Icon, ShoppingBagIcon, Table2Icon, UsersIcon } from 'lucide-react';

export default function AppSidenav() {
    return <Sidenav>
        <SidenavSeparator>Global</SidenavSeparator>
        <SidenavItem icon={<LayoutDashboardIcon />} href="/mrp">Inicio MRP</SidenavItem>
        <BackSidenavItem />
        ...
        <SidenavItem icon={<DatabaseBackupIcon />} href="/mrp/datos">Config. datos</SidenavItem>
    </Sidenav>
}