...
export default function AppLayout(props: AppLayoutProps) {
    return (
        <div>
            ...
            <aside
                className={cn('fixed top-[70px] left-0 bottom-0 hidden w-[250px] border-r overflow-y-auto max-h-full', {
            ...
            <main
                className={cn('mt-[70px] relative max-w-[100vw] overflow-x-hidden', {
